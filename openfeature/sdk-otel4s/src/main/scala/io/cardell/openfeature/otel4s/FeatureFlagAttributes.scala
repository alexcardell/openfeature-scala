...
object FeatureFlagExperimentalAttributes {
  ...
  /** The unique identifier for the flag evaluation context. For example, the
    * targeting key.
    */
  val FeatureFlagContextId: AttributeKey[String] = AttributeKey(
  ...
  /** A message providing more detail about an error that occurred during
    ...
    */
  val FeatureFlagErrorMessage: AttributeKey[String] = AttributeKey(
  ...
  /** The reason code which shows how a feature flag value was determined.
    */
  val FeatureFlagResultReason: AttributeKey[String] = AttributeKey(
  ...
  /** A semantic identifier for an evaluated flag value.
    ...
    *   `#c05543`.
    */
  val FeatureFlagResultVariant: AttributeKey[String] = AttributeKey(
    "feature_flag.result.variant"
  )

  /** The identifier of the <a
    * href="https://openfeature.dev/specification/glossary/#flag-set">flag
    * set</a> to which the feature flag belongs.
    */
  val FeatureFlagSetId: AttributeKey[String] = AttributeKey(
    "feature_flag.set.id"
  )
  ...
  /** The version of the ruleset used during the evaluation. This may be any
    ...
    */
  val FeatureFlagVersion: AttributeKey[String] = AttributeKey(
  ...
  object FeatureFlagResultReasonValue {
    ...
    implicit val attributeFromFeatureFlagResultReasonValue
        : Attribute.From[FeatureFlagResultReasonValue, String] = _.value
    ...
    /** The resolved value was the result of a dynamic evaluation, such as a
      ...
      */
    case object TargetingMatch
        extends FeatureFlagResultReasonValue("targeting_match")
